...
from   easyhybrid.gui.window_control import *
import time
...
class NewProjectDialog():
    ...
    def on_new_project_entry_changed (self, entry):
        ...
        WorkSpace = self.EasyHybridMain.EasyHybridConfig['WorkSpace']
        try:
    ...
    def on_button1_clicked_create_new_project(self, button):
        ...
        self.project          = self.EasyHybridMain.pDynamoSession
    ...
    def __init__(self, EasyHybridMain = None):
        ...
        if EasyHybridMain != None:
            #self.project           = EasyHybridMain.project
            #self.main_builder   = EasyHybridMain.builder
            self.EasyHybridMain = EasyHybridMain

        
        self.builder.add_from_file(
            'easyhybrid/gui/glade/NewProject/NewProjectDialog.glade')
