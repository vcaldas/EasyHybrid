...
class EasyMolSession (ShowHideEasyMol):
    """ Class doc """
    ...
    def load (self, infile):
        ...
        self.Vobjects[-1].actived   = True
        self.center_by_index (index =  -1)
        return True
        
    def _load_pdb_file (self, infile):
        """ Function doc """
        atoms, frames  = load_pdb_files (infile = infile)
        Vobject = mm.Vobject(label       = infile, 
			     atoms       = atoms, 
			     EMSession   = self, 
			     trajectory  = frames)
    ...
    def selection_function (self, pickedID):
        ...
        if self._picking_selection_mode:
            ...
            #self.selection_function_viewing(selected)
    ...
    def __init__ (self, parent = None, glwidget = None):
        ...
        #  VIEWING SELECTIONS
        #---------------------------------------------------------------
        selection = EasyMolViewingSelection()
        self.selections = {
                          'sel01' : selection
                          }
        ...
        #  PICKING SELECTIONS
        #---------------------------------------------------------------
        self.picking_selections =  EasyMolPickingSelection()
