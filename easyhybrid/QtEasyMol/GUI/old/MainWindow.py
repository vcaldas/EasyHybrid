...
#
# Created: Mon May 22 03:31:58 2017
...
class Ui_EasyMol(object):
    def setupUi(self, EasyMol):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("GUI/icons/NewProject.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("GUI/icons/Save2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon2)
        self.actionSave.setObjectName("actionSave")
        self.actionSave_As = QtGui.QAction(EasyMol)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("GUI/icons/Save_as.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_As.setIcon(icon3)
        self.actionSave_As.setObjectName("actionSave_As")
        self.actionMesure = QtGui.QAction(EasyMol)
        self.actionMesure.setCheckable(True)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("GUI/icons/measure.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("GUI/icons/.icon_psi24x24.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("GUI/icons/systemCheck.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionProperties.setIcon(icon6)
        self.actionProperties.setObjectName("actionProperties")
        self.actionCalculate_Energy = QtGui.QAction(EasyMol)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("GUI/icons/.icon_single_point_24x24.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("GUI/icons/.icon_minimization_24x24.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("GUI/icons/.icon_MD_24x24.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("GUI/icons/deleteSystem.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("GUI/icons/ShowCell.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
