...
#------------------------------------------------------------------------------
from GLarea import GLCanvas
#------------------------------------------------------------------------------
from AtomTypes import ATOMTYPES
#------------------------------------------------------------------------------
from pprint import pprint 
#------------------------------------------------------------------------------
from FileChooserDialog import FileChooser
#------------------------------------------------------------------------------
from pDynamoModules import pDynamoSession
#------------------------------------------------------------------------------
import sys
#------------------------------------------------------------------------------
...
class EasyHybridMain(EasyHybridConfig, EasyMolActions, MainMenu, MainToolBar):
    ...
    def __init__(self):
        ...
        self.builder.add_from_file(os.path.join("GUI/MainWindow.glade"))
